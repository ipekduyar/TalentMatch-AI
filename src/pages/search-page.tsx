...
import { POSTINGS, COMPANIES } from "@/lib/mock-data";
...
export const SearchPage = () => {
  ...
  const industries = ["All", "Finance", "Technology", "Manufacturing", "E-commerce"];
...
const PostingCard = ({ posting }: { posting: InternshipPosting; key?: string }) => {
      ...
      <div className="p-8 flex-1 flex flex-col">
        <div className="flex items-start justify-between mb-8">
           ...
           <div className="text-right">
              ...
              <p className="text-2xl font-black text-emerald-500 tracking-tighter">85%</p>
           </div>
        </div>
        ...
        <div className="flex-1 space-y-3">
           ...
           <p className="text-xs font-black text-slate-400 uppercase tracking-[0.1em]">{company?.name}</p>
